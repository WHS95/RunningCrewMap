    ...
    >
      ...
      <div className='relative z-10 p-4 bg-white shadow-sm'>
        <Link
          ...
          target='_blank'
          className='block w-full py-4 text-lg font-bold text-center text-white transition bg-gradient-to-r from-blue-500 to-purple-500 rounded-full shadow-lg hover:from-blue-600 hover:to-purple-600 active:transform active:scale-[0.98]'
        >
          주문 및 상담 카톡
        </Link>
      </div>
      ...
      <div className='py-6 bg-white'>
        <div className='px-4'>
          <h3 className='flex items-center mb-4 text-base font-medium text-gray-900'>
            모자 실제 영상
          </h3>
      ...
      <div className='flex flex-col px-4 bg-white shadow-sm'>
        ...
        <div className='py-4 space-y-3 border-b border-gray-100'>
          <h3 className='text-base font-medium text-gray-900'>제품 특징</h3>
        ...
        {/* 상품 정보 */}
        <div className='py-4 space-y-3 border-b border-gray-100'>
          <h3 className='text-base font-medium text-gray-900'>상품 정보</h3>
          <div className='ml-6 space-y-2'>
            <div className='p-3 bg-gray-50 rounded-lg'>
              <ul className='space-y-2 text-sm text-gray-700'>
                <li className='flex items-start'>
        ...
        {/* 주문 방법 */}
        <div className='py-4 space-y-3 border-b border-gray-100'>
          <h3 className='text-base font-medium text-gray-900'>주문 방법</h3>
        ...
        {/* 주의사항 */}
        <div className='py-4 space-y-3 border-b border-gray-100'>
          <h3 className='text-base font-medium text-gray-900'>주의사항</h3>
